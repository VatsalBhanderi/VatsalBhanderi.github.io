...
const Skills = ({ skills, categories }) => {
  ...
  return (
    <div className="skills">
      ...
      <div className="title">
        <h3 className="display-4 pb-5 text-center">Skills</h3>
        {/* <h3>Skills</h3> */}
        <p className="lead" style={{color: "black"}}>Note: I think these sections are silly, but everyone seems to have one.
